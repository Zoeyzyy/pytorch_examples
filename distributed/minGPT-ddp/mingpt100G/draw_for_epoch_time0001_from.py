...
def draw(epoch_i):
    ...
    if epoch_i != 9:
        ...
        data1 = ([0] * (int(step106[epoch_i]) - int(x_l))) + (from106_0_0001[int(step106[epoch_i]): int(x_l + 200000)])
        data2 = ([0] * (int(step108[epoch_i]) - int(x_l))) + (from108_0_0001[int(step108[epoch_i]): int(x_l + 200000)])
        data3 = ([0] * (int(step112[epoch_i]) - int(x_l))) + (from112_0_0001[int(step112[epoch_i]): int(x_l + 200000)])
