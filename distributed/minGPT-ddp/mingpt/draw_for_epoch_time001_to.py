...
def draw(epoch_i):
    ...
    if epoch_i != 9:
        ...
        data1 = ([0] * (int(step106[epoch_i]) - int(x_l))) + (to106_0_001[int(step106[epoch_i]): int(x_l + 20000)])
        data2 = ([0] * (int(step108[epoch_i]) - int(x_l))) + (to108_0_001[int(step108[epoch_i]): int(x_l + 20000)])
        data3 = ([0] * (int(step112[epoch_i]) - int(x_l))) + (to112_0_001[int(step112[epoch_i]): int(x_l + 20000)])
